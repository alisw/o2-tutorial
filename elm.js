...
var _user$project$DataModel$maxPaneBuildUp = function (pane) {
	var _p0 = pane;
	switch (_p0.ctor) {
		case 'ShellPane':
			return _elm_lang$core$List$length(_p0._0.content);
		case 'EditorPane':
			return _elm_lang$core$List$length(_p0._0.content);
		default:
			return _elm_lang$core$List$length(_p0._0.content);
...
var _user$project$DataModel$maxBuildUp = function (layout) {
	var _p1 = layout;
	if (_p1.ctor === 'Just') {
		switch (_p1._0.ctor) {
			case 'TwoPanesStep':
				...
				return A2(
					...
					_user$project$DataModel$maxPaneBuildUp(_p2.leftPane),
					_user$project$DataModel$maxPaneBuildUp(_p2.rightPane));
			case 'SinglePaneStep':
				return _user$project$DataModel$maxPaneBuildUp(_p1._0._0.pane);
			default:
				return 1;
		}
	} else {
...
var _user$project$DataModel$foldBuildup = F2(
	function (next, acc) {
		var _p3 = next;
		switch (_p3.ctor) {
			case 'Reuse':
			...
			case 'ReplaceLast':
				return A2(
					...
					A2(
						...
						_elm_lang$core$List$length(acc) - 1,
						acc),
					{
						ctor: '::',
						_0: _p3._0,
			...
			default:
				return A2(
					...
					A2(
						_elm_lang$core$List$take,
						_elm_lang$core$List$length(acc) - _p3._0,
						acc),
					{
						ctor: '::',
						_0: _p3._1,
...
var _user$project$DataModel$evaluateBuildUp = F2(
	function (n, allBuildups) {
		var buildups = A2(_elm_lang$core$List$take, n + 1, allBuildups);
		return A2(
			_elm_lang$core$String$join,
			'',
			A3(
				_elm_lang$core$List$foldl,
				_user$project$DataModel$foldBuildup,
				{ctor: '[]'},
				buildups));
	});
var _user$project$DataModel$Background = function (a) {
	return {template: a};
};
var _user$project$DataModel$Story = F2(
	function (a, b) {
		return {title: a, layouts: b};
	});
var _user$project$DataModel$HeaderPane = function (a) {
	return {ctor: 'HeaderPane', _0: a};
};
var _user$project$DataModel$EditorPane = function (a) {
	return {ctor: 'EditorPane', _0: a};
};
var _user$project$DataModel$ShellPane = function (a) {
	return {ctor: 'ShellPane', _0: a};
};
var _user$project$DataModel$ImageStep = function (a) {
	return {ctor: 'ImageStep', _0: a};
};
var _user$project$DataModel$SinglePaneStep = function (a) {
	return {ctor: 'SinglePaneStep', _0: a};
};
var _user$project$DataModel$TwoPanesStep = function (a) {
	return {ctor: 'TwoPanesStep', _0: a};
};
var _user$project$DataModel$ReplaceLastN = F2(
	function (a, b) {
		return {ctor: 'ReplaceLastN', _0: a, _1: b};
	});
var _user$project$DataModel$ReplaceLast = function (a) {
	return {ctor: 'ReplaceLast', _0: a};
};
var _user$project$DataModel$AppendP = function (a) {
	return {ctor: 'AppendP', _0: a};
};
var _user$project$DataModel$Append = function (a) {
	return {ctor: 'Append', _0: a};
};
var _user$project$DataModel$Replace = function (a) {
	return {ctor: 'Replace', _0: a};
};
var _user$project$DataModel$Single = function (a) {
	return {ctor: 'Single', _0: a};
};
var _user$project$DataModel$simpleBuildUp = function (l) {
	var _p4 = l;
	if (_p4.ctor === '[]') {
		return {ctor: '[]'};
	} else {
		if (_p4._1.ctor === '[]') {
			return {
				ctor: '::',
				_0: _user$project$DataModel$Single(_p4._0),
				_1: {ctor: '[]'}
			};
		} else {
			return A2(
				...
				A2(_elm_lang$core$List$map, _user$project$DataModel$Append, _p4._1));
		}
	}
};
var _user$project$DataModel$Reuse = {ctor: 'Reuse'};

var _user$project$Story$story = {
	title: 'ALICE O2 Primer',
	layouts: {
		ctor: '::',
		_0: _user$project$DataModel$SinglePaneStep(
			{
				title: 'Welcome',
				header: _user$project$DataModel$HeaderPane(
					{
						content: {
							ctor: '::',
							_0: _user$project$DataModel$Single('\nUse arrow keys to navigate.\n\n'),
							_1: {
								ctor: '::',
								_0: _user$project$DataModel$Replace('\nThe purpose of this tutorial is to guide you step by step through the set up of\nyour O2 working environment, the creation of your own FairRoot devices and\ntheir deployment using DDS.\n\n**Now lets get started!**\n'),
								_1: {
									ctor: '::',
									_0: _user$project$DataModel$Append('\nFirst of all this tutorial assumes you are in `~/alice` and that\'s\nwhat we will use as a workarea. Notice that we set the `WORKAREA`\nenvironment variable to it.\n'),
									_1: {ctor: '[]'}
								}
							}
						}
					}),
				pane: _user$project$DataModel$ShellPane(
					{
						content: {
							ctor: '::',
							_0: _user$project$DataModel$Single('\n$\n'),
							_1: {
								ctor: '::',
								_0: _user$project$DataModel$Reuse,
								_1: {
									ctor: '::',
									_0: _user$project$DataModel$Replace('\n$ mkdir -p ~/alice\n\n$ cd ~/alice\n\n$ pwd\n/Users/me/alice\n\n$ export WORKAREA=$PWD\n'),
									_1: {ctor: '[]'}
		...
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _user$project$DataModel$ImageStep(
							{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _user$project$DataModel$TwoPanesStep(
											{
												title: 'The Sampler',
												header: _user$project$DataModel$HeaderPane(
													{
												...
												leftPane: _user$project$DataModel$ShellPane(
													{
														content: {
															ctor: '::',
												...
												rightPane: _user$project$DataModel$EditorPane(
													{
														content: {
															ctor: '::',
														...
														header: _user$project$DataModel$HeaderPane(
															{
																content: {
																	...
																	_1: {
																		ctor: '::',
																		_0: _user$project$DataModel$Append(' The rest of the code is similar to the Sampler one, with\nthe inner loop for the `RUNNING` state.\n\n'),
																		_1: {ctor: '[]'}
																	}
																}
															}),
														leftPane: _user$project$DataModel$EditorPane(
															{
													...
													_0: _user$project$DataModel$SinglePaneStep(
														{
																	...
																	content: {
																		...
																		_1: {
																			...
																			_1: {
																				...
																				_1: {
																					ctor: '::',
																					_0: _user$project$DataModel$Append('- Create the map of channel from the configuration.\n'),
																					_1: {
																						ctor: '::',
																						_0: _user$project$DataModel$Append('- Set the transport type and any other option found in the\nconfiguration.\n'),
																						_1: {
																							ctor: '::',
																							_0: _user$project$DataModel$Append('- Initialise and transition the state machine until the\nmain loop is reached.\n'),
																							_1: {ctor: '[]'}
																						}
																					}
																				}
															...
															pane: _user$project$DataModel$EditorPane(
																{
																	...
																	_0: _user$project$DataModel$TwoPanesStep(
																		{
																			...
																			header: _user$project$DataModel$HeaderPane(
																				{
																					content: {
																						...
																						_1: {
																							ctor: '::',
																							_0: _user$project$DataModel$Append('Notice how we also need to provide the id of the device on the command\nline so that it\'s configuration can be picked up from file.'),
																							_1: {ctor: '[]'}
																						}
																					}
																				}),
																			...
																			rightPane: _user$project$DataModel$ShellPane(
																				{
																					content: {
																						ctor: '::',
																						_0: _user$project$DataModel$Single('\n$ runSink --id sink1 \\\n          --config-json-file examples/tutorial-1/config.json\n'),
...
var _user$project$TutorialStyles_Styles$descriptionStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'padding-top', _1: '20px'},
		_1: {ctor: '[]'}
	});
var _user$project$TutorialStyles_Styles$topBarStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '-webkit-backface-visibility', _1: 'hidden'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: '-webkit-background-clip', _1: 'border-box'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: '-webkit-background-origin', _1: 'padding-box'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: '-webkit-background-size', _1: 'auto'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: '-webkit-transition-delay', _1: '0s'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: '-webkit-transition-duration', _1: '0.7s'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: '-webkit-transition-property', _1: 'top'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: '-webkit-transition-timing-function', _1: 'ease-in-out'},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'background-attachment', _1: 'scroll'},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'background-clip', _1: 'border-box'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'background-color', _1: 'rgb(237, 237, 237)'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'background-image', _1: 'none'},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'background-origin', _1: 'padding-box'},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'background-size', _1: 'auto'},
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'border-bottom-color', _1: 'rgb(211, 211, 211)'},
																_1: {
																	ctor: '::',
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: {ctor: '_Tuple2', _0: 'color', _1: 'rgb(67, 67, 67)'},
																			_1: {
																				ctor: '::',
																				...
																				_1: {
																					...
																					_1: {
																						...
																						_1: {
																							...
																							_1: {
																								ctor: '::',
																								_0: {ctor: '_Tuple2', _0: 'transition-delay', _1: '0s'},
																								_1: {
																									ctor: '::',
																									_0: {ctor: '_Tuple2', _0: 'transition-duration', _1: '0.7s'},
																									_1: {
																										ctor: '::',
																										_0: {ctor: '_Tuple2', _0: 'transition-property', _1: 'top'},
																										_1: {
																											ctor: '::',
																											_0: {ctor: '_Tuple2', _0: 'transition-timing-function', _1: 'ease-in-out'},
																											_1: {
																												ctor: '::',
...
var _user$project$TutorialStyles_Styles$completeStep = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '-webkit-background-clip', _1: 'border-box'},
		_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'color', _1: '#1eb29b'},
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'OpenSansRegular, \'Helvetica Neue\', Helvetica, Arial, sans-serif'},
														_1: {
															ctor: '::',
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'list-style-image', _1: 'none'},
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple2', _0: 'list-style-position', _1: 'outside'},
																		_1: {
																			ctor: '::',
...
var _user$project$TutorialStyles_Styles$incompleteStep = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '-webkit-background-clip', _1: 'border-box'},
		_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'color', _1: '#5c5c5c'},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'cursor', _1: 'auto'},
											_1: {
...
var _user$project$TutorialStyles_Styles$stepStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '-webkit-background-clip', _1: 'border-box'},
		_1: {
...
var _user$project$TutorialStyles_Styles$stepperStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'color', _1: 'rgb(67, 67, 67)'},
		_1: {
													...
													_1: {
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'padding-top', _1: '7px'},
																	_1: {ctor: '[]'}
																}
															}
														}
...
var _user$project$TutorialStyles_Styles$titleStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'color', _1: 'rgb(0, 0, 0)'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'display', _1: 'inline'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'font-family', _1: '\'Helvetica Neue\', Helvetica, Arial, sans-serif'},
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'font-variant', _1: 'normal'},
							_1: {
								ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'text-shadow', _1: 'rgb(255, 255, 255) 0px 1px 0px'},
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$TutorialStyles_Styles$editorStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '-webkit-background-clip', _1: 'border-box'},
		_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'color', _1: 'rgb(4, 4, 4)'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'display', _1: 'block'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'Monaco, Courier, font-monospace'},
													_1: {
														ctor: '::',
															...
															_1: {
																...
																_1: {
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: {ctor: '_Tuple2', _0: 'line-height', _1: '23px'},
																			_1: {
																				ctor: '::',
																				_0: {ctor: '_Tuple2', _0: 'margin-bottom', _1: '0px'},
																				_1: {
...
var _user$project$TutorialStyles_Styles$shellStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '-webkit-background-clip', _1: 'border-box'},
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'background-color', _1: 'rgb(66, 66, 66)'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'background-image', _1: 'none'},
								_1: {
...
var _user$project$TutorialStyles_Styles$shellTabStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'background-color', _1: 'rgb(239, 237, 238)'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'background-image', _1: '-webkit-linear-gradient(top, rgb(239, 237, 238), rgb(193, 193, 193))'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'border-bottom-color', _1: 'rgb(67, 67, 67)'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'border-bottom-left-radius', _1: '0px'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'border-bottom-right-radius', _1: '0px'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'border-bottom-style', _1: 'none'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'border-bottom-width', _1: '0px'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'border-image-outset', _1: '0px'},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'border-image-repeat', _1: 'stretch'},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'border-image-slice', _1: '100%'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'border-image-source', _1: 'none'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'border-image-width', _1: '1'},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'border-left-color', _1: 'rgb(98, 135, 164)'},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'border-left-style', _1: 'solid'},
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'border-left-width', _1: '1px'},
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'border-right-color', _1: 'rgb(98, 135, 164)'},
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple2', _0: 'border-right-style', _1: 'solid'},
																		_1: {
																			ctor: '::',
																			_0: {ctor: '_Tuple2', _0: 'border-right-width', _1: '1px'},
																			_1: {
																				ctor: '::',
																				_0: {ctor: '_Tuple2', _0: 'border-top-color', _1: 'rgb(98, 135, 164)'},
																				_1: {
																					ctor: '::',
																					_0: {ctor: '_Tuple2', _0: 'border-top-left-radius', _1: '3px'},
																					_1: {
																						ctor: '::',
																						_0: {ctor: '_Tuple2', _0: 'border-top-right-radius', _1: '3px'},
																						_1: {
																							ctor: '::',
																							_0: {ctor: '_Tuple2', _0: 'border-top-style', _1: 'solid'},
																							_1: {
																								ctor: '::',
																								_0: {ctor: '_Tuple2', _0: 'border-top-width', _1: '1px'},
																								_1: {
																									ctor: '::',
																									_0: {ctor: '_Tuple2', _0: 'color', _1: 'rgb(67, 67, 67)'},
																									_1: {
...
var _user$project$TutorialStyles_Styles$innerStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'color', _1: 'rgb(67, 67, 67)'},
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'height', _1: '600'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'margin-bottom', _1: '0px'},
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'padding-left', _1: '60px'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'padding-right', _1: '60px'},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'padding-top', _1: '0px'},
														_1: {ctor: '[]'}
...
var _user$project$TutorialStyles_Styles$bodyStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'height', _1: '700px'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'border-top-color', _1: 'rgb(38, 89, 127)'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'border-top-style', _1: 'solid'},
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'background-color', _1: 'rgb(59, 132, 192)'},
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$TutorialStyles_Styles$headerStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'color', _1: 'rgb(67, 67, 67'},
		_1: {
			...
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'max-width', _1: '80%'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'line-height', _1: '25.600000381469727px'},
					_1: {
						ctor: '::',
...
var _user$project$O2Tutorial$handleArrows = F2(
	function (model, a) {
		var nextPage = A2(
			_elm_lang$core$Basics$min,
			A2(_elm_lang$core$Basics$max, 0, model.currentPage + a.x),
			_elm_lang$core$Array$length(model.slidesIndex) - 1);
		var index = A2(_elm_lang$core$Array$get, nextPage, model.slidesIndex);
		var _p0 = index;
		if (_p0.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{currentPage: nextPage, currentSection: _p0._0.section, currentBuildUp: _p0._0.buildup});
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					pageError: _elm_lang$core$Maybe$Just(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Page not found',
							_elm_lang$core$Basics$toString(nextPage)))
				});
		}
	});
var _user$project$O2Tutorial$handleKeys = F2(
	function (model, msg) {
		var pressedKeys = A2(
			_ohanhi$keyboard_extra$Keyboard_Extra$update,
			msg,
			{ctor: '[]'});
		var arrows = _ohanhi$keyboard_extra$Keyboard_Extra$arrows(pressedKeys);
		return A2(_user$project$O2Tutorial$handleArrows, model, arrows);
	});
var _user$project$O2Tutorial$errorDialog = function (model) {
	var _p1 = model.pageError;
	if (_p1.ctor === 'Nothing') {
		return {ctor: '[]'};
	} else {
		return {
...
var _user$project$O2Tutorial$currentSectionTitle = function (model) {
	var currentSlide = A2(_elm_lang$core$Array$get, model.currentSection, model.slides);
	var _p2 = currentSlide;
	if (_p2.ctor === 'Just') {
		var _p3 = _p2._0;
		switch (_p3.ctor) {
			case 'ImageStep':
...
var _user$project$O2Tutorial$title = function (model) {
	var titleStyle = {
		ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(titleStyle),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								' > ',
								_user$project$O2Tutorial$currentSectionTitle(model)))),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$O2Tutorial$stepKind = F3(
	function (currentSection, currentBuildUp, model) {
		return (_elm_lang$core$Native_Utils.cmp(currentSection, model.currentSection) > 0) ? _user$project$TutorialStyles_Styles$incompleteStep : ((_elm_lang$core$Native_Utils.eq(currentSection, model.currentSection) && (_elm_lang$core$Native_Utils.cmp(currentBuildUp, model.currentBuildUp) > 0)) ? _user$project$TutorialStyles_Styles$incompleteStep : _user$project$TutorialStyles_Styles$completeStep);
	});
var _user$project$O2Tutorial$stepper = function (model) {
	var navigationButton = function (indexEntry) {
		var _p4 = indexEntry;
		var section = _p4.section;
		var buildup = _p4.buildup;
		var newHash = A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(section),
			A2(
				_elm_lang$core$Basics_ops['++'],
				'/',
				_elm_lang$core$Basics$toString(0)));
		var stepBullet = function () {
			var _p5 = buildup;
			if (_p5 === 0) {
				return '⬤';
			} else {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$TutorialStyles_Styles$stepStyle,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_0: _elm_lang$html$Html_Attributes$href(
							A2(_elm_lang$core$Basics_ops['++'], '#!', newHash)),
						_1: {
							ctor: '::',
							_0: A3(_user$project$O2Tutorial$stepKind, section, buildup, model),
							_1: {ctor: '[]'}
						}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(stepBullet),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
	};
	var navigationLink = F2(
		function (model, slide) {
			return _rgrempel$elm_route_url$RouteUrl_Builder$toUrlChange(
				A2(
					_rgrempel$elm_route_url$RouteUrl_Builder$replacePath,
					{
						ctor: '::',
						_0: _elm_lang$core$Basics$toString(model.currentSection),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Basics$toString(model.currentBuildUp),
							_1: {ctor: '[]'}
						}
					},
					_rgrempel$elm_route_url$RouteUrl_Builder$modifyEntry(_rgrempel$elm_route_url$RouteUrl_Builder$builder)));
		});
	var numberOfSlides = _elm_lang$core$Array$length(model.slides);
	return A2(
		_elm_lang$html$Html$ol,
		{
			ctor: '::',
			_0: _user$project$TutorialStyles_Styles$stepperStyle,
			_1: {ctor: '[]'}
		},
		_elm_lang$core$Array$toList(
			A2(_elm_lang$core$Array$map, navigationButton, model.slidesIndex)));
};
var _user$project$O2Tutorial$builderForStateFrom = function (model) {
	return A2(
		_rgrempel$elm_route_url$RouteUrl_Builder$replacePath,
		{
			ctor: '::',
...
var _user$project$O2Tutorial$delta2update = F2(
	function (old, $new) {
		var builder = _user$project$O2Tutorial$builderForStateFrom($new);
		var same = _elm_lang$core$Native_Utils.eq(old.currentSection, $new.currentSection) && _elm_lang$core$Native_Utils.eq(old.currentBuildUp, $new.currentBuildUp);
		var _p6 = same;
		if (_p6 === false) {
			return _elm_lang$core$Maybe$Just(
				_rgrempel$elm_route_url$RouteUrl_Builder$toHashChange(builder));
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
var _user$project$O2Tutorial$moveToPage = F3(
	function (section, buildup, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{currentSection: section, currentBuildUp: buildup});
	});
var _user$project$O2Tutorial$update = F2(
	function (action, model) {
		...
		switch (_p7.ctor) {
			...
			case 'MoveToPage':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$O2Tutorial$moveToPage, _p7._0, _p7._1, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'KeyMsg':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$O2Tutorial$handleKeys, model, _p7._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Arrows':
				return {
					ctor: '_Tuple2',
					_0: function (m) {
						return A3(_user$project$O2Tutorial$moveToPage, m.currentSection, m.currentBuildUp, m);
					}(
						A2(_user$project$O2Tutorial$handleArrows, model, _p7._0)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							pageError: _elm_lang$core$Maybe$Just(_p7._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$O2Tutorial$computeBuildupList = function (layout) {
	return A2(
		_elm_lang$core$List$range,
		0,
		_user$project$DataModel$maxBuildUp(
			_elm_lang$core$Maybe$Just(layout)) - 1);
};
var _user$project$O2Tutorial$computeSlideIndex = function (slides) {
	var enumeratedSlides = A2(
	...
	var nestedIndex = A2(
		...
		function (_p8) {
			...
			return A2(
				...
				function (_p10) {
					var _p11 = _p10;
					return {ctor: '_Tuple2', _0: _p9._0, _1: _p11._0};
				},
				_p9._1);
		},
		A2(
			...
			function (_p12) {
				...
				return {
					...
					_1: A2(
						...
						_user$project$O2Tutorial$computeBuildupList(_p13._1))
				};
			},
			enumeratedSlides));
	return _elm_lang$core$Array$fromList(
		A2(
			...
			function (_p14) {
				var _p15 = _p14;
				return {section: _p15._0, buildup: _p15._1};
			},
			A2(
...
var _user$project$O2Tutorial$model = {
	pressedKeys: {ctor: '[]'},
	currentPage: 0,
	currentSection: 0,
	currentBuildUp: 0,
	title: _user$project$Story$story.title,
	slides: _elm_lang$core$Array$fromList(_user$project$Story$story.layouts),
	slidesIndex: _user$project$O2Tutorial$computeSlideIndex(_user$project$Story$story.layouts),
	pageError: _elm_lang$core$Maybe$Nothing
};
var _user$project$O2Tutorial$init = {ctor: '_Tuple2', _0: _user$project$O2Tutorial$model, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$O2Tutorial$render = F2(
	function (buildup, pane) {
		var $eval = _user$project$DataModel$evaluateBuildUp(buildup);
		var _p16 = pane;
		switch (_p16.ctor) {
			case 'ShellPane':
				return {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$TutorialStyles_Styles$shellTabStyle,
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$TutorialStyles_Styles$titleStyle,
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Welcome to Alice O2'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$TutorialStyles_Styles$shellStyle,
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
				...
				return {
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(_p17.filename),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$TutorialStyles_Styles$editorStyle,
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('lang-cpp'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
...
var _user$project$O2Tutorial$applyLayout = F2(
	function (buildup, layout) {
		var _p18 = layout;
		switch (_p18.ctor) {
			case 'SinglePaneStep':
				var _p19 = _p18._0;
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$TutorialStyles_Styles$headerStyle,
								_1: {ctor: '[]'}
							},
							A2(_user$project$O2Tutorial$render, buildup, _p19.header)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
								{
									ctor: '::',
									_0: _user$project$TutorialStyles_Styles$bodyStyle,
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('pure-u-1-24'),
													_1: {ctor: '[]'}
												},
												{ctor: '[]'}),
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('pure-u-22-24'),
														_1: {ctor: '[]'}
													},
													A2(_user$project$O2Tutorial$render, buildup, _p19.pane)),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$div,
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							A2(_user$project$O2Tutorial$render, buildup, _p20.header)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$div,
										{
											...
											_1: {
												ctor: '::',
												_0: _user$project$TutorialStyles_Styles$innerStyle,
												_1: {ctor: '[]'}
											}
										},
										{
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														A2(_user$project$O2Tutorial$render, buildup, _p20.leftPane)),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															A2(_user$project$O2Tutorial$render, buildup, _p20.rightPane)),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							A2(_user$project$O2Tutorial$render, buildup, _p21.header)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
										...
										},
										{
											...
											_0: A2(
												_elm_lang$html$Html$div,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('pure-u-1'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$style(
																{
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$src(_p21.image),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('A test image'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}),
...
var _user$project$O2Tutorial$currentBackground = function (model) {
	var maybeBackground = A2(_elm_lang$core$Array$get, model.currentSection, model.slides);
	var _p22 = maybeBackground;
	if (_p22.ctor === 'Just') {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: A2(_user$project$O2Tutorial$applyLayout, model.currentBuildUp, _p22._0),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(
...
var _user$project$O2Tutorial$stylesheet = function () {
	var children = {ctor: '[]'};
	var attrs = {
		ctor: '::',
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'href', 'pure-min.css'),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'integrity', 'sha384-nn4HPE8lTHyVtfCBi5yW9d20FjT8BJwUXyWZT9InLYax14RDjBj46LmSztkmNP9w'),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$O2Tutorial$SlideIndexEntry = F2(
	function (a, b) {
		return {section: a, buildup: b};
	});
var _user$project$O2Tutorial$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {pressedKeys: a, currentPage: b, currentSection: c, currentBuildUp: d, title: e, slides: f, slidesIndex: g, pageError: h};
	});
var _user$project$O2Tutorial$Arrows = function (a) {
	return {ctor: 'Arrows', _0: a};
};
var _user$project$O2Tutorial$arrowNavigator = function (model) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$span,
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$O2Tutorial$Arrows(
						{x: -1, y: 0})),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
		...
		_1: {
			...
			_0: _elm_lang$html$Html$text(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(model.currentSection),
						A2(
							_elm_lang$core$Basics_ops['++'],
							' / Step: ',
							_elm_lang$core$Basics$toString(model.currentBuildUp))))),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$span,
...
var _user$project$O2Tutorial$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
			...
			{
				ctor: '::',
				_0: _user$project$O2Tutorial$stylesheet,
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$O2Tutorial$errorDialog(model),
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$TutorialStyles_Styles$topBarStyle,
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$O2Tutorial$title(model),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('pure-u-1-3'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _user$project$O2Tutorial$stepper(model),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('pure-u-1-6'),
											_1: {ctor: '[]'}
										},
										_user$project$O2Tutorial$arrowNavigator(model)),
									_1: {ctor: '[]'}
								}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$TutorialStyles_Styles$descriptionStyle,
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _user$project$O2Tutorial$currentBackground(model),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$O2Tutorial$KeyMsg = function (a) {
	return {ctor: 'KeyMsg', _0: a};
};
var _user$project$O2Tutorial$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Sub$map, _user$project$O2Tutorial$KeyMsg, _ohanhi$keyboard_extra$Keyboard_Extra$subscriptions),
			_1: {ctor: '[]'}
		});
};
var _user$project$O2Tutorial$MoveToPage = F2(
	function (a, b) {
		return {ctor: 'MoveToPage', _0: a, _1: b};
	});
var _user$project$O2Tutorial$UnknownPage = function (a) {
	return {ctor: 'UnknownPage', _0: a};
};
var _user$project$O2Tutorial$location2messages = function (location) {
	var builder = _rgrempel$elm_route_url$RouteUrl_Builder$fromHash(location.hash);
	var _p23 = _rgrempel$elm_route_url$RouteUrl_Builder$path(builder);
	if (_p23.ctor === '::') {
		if (_p23._1.ctor === '::') {
			var _p24 = {
				ctor: '_Tuple2',
				_0: _elm_lang$core$String$toInt(_p23._0),
				_1: _elm_lang$core$String$toInt(_p23._1._0)
			};
			if (((_p24.ctor === '_Tuple2') && (_p24._0.ctor === 'Ok')) && (_p24._1.ctor === 'Ok')) {
				return {
					ctor: '::',
					_0: A2(_user$project$O2Tutorial$MoveToPage, _p24._0._0, _p24._1._0),
					_1: {ctor: '[]'}
				};
			} else {
				return {
					ctor: '::',
					_0: _user$project$O2Tutorial$UnknownPage(
						A2(
							_elm_lang$core$String$join,
							'/',
							_rgrempel$elm_route_url$RouteUrl_Builder$path(builder))),
					_1: {ctor: '[]'}
				};
			}
		} else {
			var _p25 = _elm_lang$core$String$toInt(_p23._0);
			if (_p25.ctor === 'Ok') {
				return {
					ctor: '::',
					_0: A2(_user$project$O2Tutorial$MoveToPage, _p25._0, 0),
					_1: {ctor: '[]'}
				};
			} else {
				return {
		...
		return {
			ctor: '::',
			_0: A2(_user$project$O2Tutorial$MoveToPage, 0, 0),
			_1: {ctor: '[]'}
		};
	}
};
var _user$project$O2Tutorial$main = _rgrempel$elm_route_url$RouteUrl$program(
	{delta2url: _user$project$O2Tutorial$delta2update, location2messages: _user$project$O2Tutorial$location2messages, init: _user$project$O2Tutorial$init, update: _user$project$O2Tutorial$update, view: _user$project$O2Tutorial$view, subscriptions: _user$project$O2Tutorial$subscriptions})();
var _user$project$O2Tutorial$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['O2Tutorial'] = Elm['O2Tutorial'] || {};
if (typeof _user$project$O2Tutorial$main !== 'undefined') {
    _user$project$O2Tutorial$main(Elm['O2Tutorial'], 'O2Tutorial', undefined);
}
